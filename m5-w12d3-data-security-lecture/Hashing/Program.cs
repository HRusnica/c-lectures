...
namespace Hashing
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("Same Salt (10)".PadRight(20) + HashPasswordWithPBKDF2(password, salt, 10));
            Console.WriteLine("Same Salt (10)".PadRight(20) + HashPasswordWithPBKDF2(password, salt, 10));
            Console.WriteLine("Same Salt (100)".PadRight(20) + HashPasswordWithPBKDF2(password, salt, 100));
            Console.WriteLine("Same Salt (100)".PadRight(20) + HashPasswordWithPBKDF2(password, salt, 100));
            Console.WriteLine("Same Salt (10000)".PadRight(20) + HashPasswordWithPBKDF2(password, salt, 10000));
            Console.WriteLine("Same Salt (10000)".PadRight(20) + HashPasswordWithPBKDF2(password, salt, 10000));
            ...
            Console.WriteLine("Random Salt (10)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 10));
            Console.WriteLine("Random Salt (10)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 10));
            Console.WriteLine("Random Salt (100)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 100));
            Console.WriteLine("Random Salt (100)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 100));
            Console.WriteLine("Random Salt (100000)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 100000));
            Console.WriteLine("Random Salt (100000)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 100000));
            Console.WriteLine("Random Salt (1000000)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 1000000));
            Console.WriteLine("Random Salt (1000000)".PadRight(20) + HashPasswordWithPBKDF2(password, 8, 1000000));
